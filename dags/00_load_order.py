...
with DAG(
    ...
    python_transform = DockerOperator(
        ...
        mounts=[
            Mount(source='/home/ubuntu/DST_MLOPS_03_Airflow/data/to_ingest', target='/app/data/to_ingest', type='bind')
        ]
    )
    ...
    python_load = DockerOperator(
        ...
        command='python3 main.py',
        network_mode='dst_mlops_03_airflow_default',
        mounts=[
            Mount(source='/home/ubuntu/DST_MLOPS_03_Airflow/data/to_ingest', target='/app/data/to_ingest', type='bind')
        ]
    )
